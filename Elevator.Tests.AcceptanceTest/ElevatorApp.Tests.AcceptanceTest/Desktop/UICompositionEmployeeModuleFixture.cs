...
using ElevatorApp.Tests.AcceptanceTest.TestEntities.Assertion;
using System.Threading;
using System.Text.RegularExpressions;

namespace ElevatorApp.Tests.AcceptanceTest.Desktop
{
    /// <summary>
    ...
    [DeploymentItem(@"..\..\..\..\ElevatorApp_Desktop\bin\Debug", "WPF")]
#else
    [DeploymentItem(@"TestData", "TestData")]
    [DeploymentItem(@"..\..\..\..\ElevatorApp_Desktop\bin\Release", "WPF")]
#endif

    [TestClass]
    public class ElevatorAppEmployeeModuleFixture : FixtureBase<WpfAppLauncher>
    {
        ...
        public void MyTestInitialize()
        {
            ...
            ElevatorAppPage<WpfAppLauncher>.Window = base.LaunchApplication(currentOutputPath + GetDesktopApplication(), GetDesktopApplicationTitle())[0];
            ElevatorAppPage<WpfAppLauncher>.Window.SetFocus();
            Thread.Sleep(500);
        }
        ...
        /// </summary>
        [TestMethod]
        public void DesktopElevatorAppLaunchTest()
        {
            Assert.IsNotNull(ElevatorAppPage<WpfAppLauncher>.Window, "UI composition application is not launched.");
        }
        ...
        /// </summary>
        [TestMethod]
        public void ElevatorAppValidateEmployeeSelection()
        {
            ElevatorAppAssertion<WpfAppLauncher>.AssertEmployeeSelection();
        }
        ...
        /// </summary>
        [TestMethod]
        public void ElevatorAppValidateGeneralDataForAllEmployees()
        {
            ElevatorAppAssertion<WpfAppLauncher>.AssertEmployeeGeneralData();
        }
        ...
        /// </summary>
        [TestMethod]
        public void ElevatorAppValidateProjects()
        {
            ElevatorAppAssertion<WpfAppLauncher>.AssertEmployeeCurrentProjects();
        }
